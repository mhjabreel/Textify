...
class RNNEncoder(Encoder):
    ...
    def call(self, inputs, sequence_length=None):
        ...
        if not self._bidirectional:
            ...
            if self._residual and reduce_fn == concat_reduce_fn:
                if self._num_units % 2 != 0:
                    raise EncoderException("The number of units in case of bidirectional RNN, "
                                "concat reducer and residual connection must be even. Got %d instead." % self._num_units, error_code=200)
